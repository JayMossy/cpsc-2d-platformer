...
export function createRandomPits({ minWidth = 4, maxWidth = 5, minGap = 12, maxGap = 25, minDepth = 2, maxDepth = 4, } = {}) {
    let x = 10;
    while (x < Mcols - 10) {
...
/* ------ Random Platforms ------ */
export function createRandomPlatforms({ minWidth = 4, maxWidth = 10, minGap = 8, maxGap = 18, minHeight = 10, maxHeight = 12 } = {}) {
    let x = 10;
    while (x < Mcols - 10) {
