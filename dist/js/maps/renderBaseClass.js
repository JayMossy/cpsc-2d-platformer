...
export class BaseRender {
    ...
    render() {
        ...
        this.ctx.strokeRect(this.player.x - this.camera.x, this.player.y - this.camera.y, this.player.w, this.player.h);
        ...
        this.playerAnimator.draw(this.ctx, this.player.x - this.camera.x, this.player.y - this.camera.y, this.player.w, this.player.h);
    }
}
